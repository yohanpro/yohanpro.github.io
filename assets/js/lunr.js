  ...
  (e.version = "0.7.1"),
    ...
    (e.tokenizer = function(t) {
      ...
      var n = t
        ...
        .trim()
        .toLowerCase();
      return "undefined" != typeof nodejieba_segment
        ? nodejieba_segment.cut(n, true)
    ...
    (e.Pipeline.prototype.run = function(e) {
      for (
        var t = [], n = e.length, i = this._stack.length, r = 0;
        n > r;
        r++
      ) {
        for (
          var o = e[r], s = 0;
          i > s && ((o = this._stack[s](o, r, e)), void 0 !== o && "" !== o);
          s++
        );
        void 0 !== o && "" !== o && t.push(o);
      }
    ...
    (e.Vector.prototype.insert = function(t, n) {
      ...
      if (t < i.idx)
        return (this.list = new e.Vector.Node(t, n, i)), this.length++;
    ...
    (e.Vector.prototype.dot = function(e) {
      for (var t = this.list, n = e.list, i = 0; t && n; )
        t.idx < n.idx
          ...
          : t.idx > n.idx
          ? (n = n.next)
          : ((i += t.val * n.val), (t = t.next), (n = n.next));
      return i;
    }),
    ...
    (e.Index.prototype.tokenizer = function(t) {
      var n = t.label && t.label in e.tokenizer.registeredFunctions;
      return (
        n ||
          e.utils.warn(
    ...
    (e.Index.prototype.search = function(t) {
      ...
      n.forEach(function(t, n, s) {
        var a = (1 / s.length) * this._fields.length * o,
          h = this,
          u = this.tokenStore.expand(t).reduce(function(n, r) {
            var o = h.corpusTokens.indexOf(r),
              s = h.idf(r),
              u = 1,
              l = new e.SortedSet();
            if (r !== t) {
              var c = Math.max(3, r.length - t.length);
              u = 1 / Math.log(c);
            }
            o > -1 && i.insert(o, a * s * u);
            for (
              var d = h.tokenStore.get(r),
                f = Object.keys(d),
                p = f.length,
                v = 0;
              p > v;
    ...
    (e.TokenStore.prototype.add = function(e, t, n) {
      ...
      return (
        i in n || (n[i] = { docs: {} }),
        0 === r.length
          ? ((n[i].docs[t.ref] = t), void (this.length += 1))
          : this.add(r, t, n[i])
      );
    }),
